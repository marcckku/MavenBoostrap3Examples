...
public class ControllerPagineBootstrap  extends HttpServlet {// INSERITO IL 9 MAGG 2018  extends HttpServlet
  ...
  private static final Logger LOGGER = Logger.getLogger(ControllerPagineBootstrap.class.getName());
    ...
    //**************
      /*  modificato/inserito il 28/01/19 **/
    
   
    //Floating-SideBar
      @RequestMapping(value = "/Floating-SideBar-download", method = RequestMethod.GET)
    public String floating_SideBar() {
        return "Floating-SideBar";
    }
    
    
     // container-app
    @RequestMapping(value = "/container-app", method = RequestMethod.GET)
    public String container_app() {
        return    "container-app";
    }
    
    // container-app-test
    @RequestMapping(value = "/container-app-test", method = RequestMethod.GET)
    public String container_app_test() {
        return    "container-app-test";
    }
    
      // container-app
    @RequestMapping(value = "/menu-slider-scroll-down", method = RequestMethod.GET)
    public String menu_slider_scroll_down() {
        return    "menu-slider-scroll-down";
    }
    ...
    ///contiene tutte le views bootstrap link 
    @RequestMapping(value = "/", method = RequestMethod.GET)
    public String menu() {
        /// LOGGER.log(Level.INFO, "com.bootstrap.controller.ControllerPagineBootstrap.getHrefPage()\t {0}", page);
         String gotoUrl="index-app";
          LOGGER.info("\n\t current page:= /" + " and goto=" + gotoUrl);
        return "index-app";
    }
